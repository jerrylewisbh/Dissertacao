...
\begingroup
    ...
    \include{Lists/listaNomenclaturas}
\endgroup
    ...
    %Capítulos
    \setcounter{page}{1}
    \input{Chapters/cap-intro}
	\input{Chapters/cap-concepts}
    \input{Chapters/cap-graph-analysis}
    \input{Chapters/cap-methodology}  
 	\input{Chapters/cap-experiments}
    \input{Chapters/cap-related-works}
    \input{Chapters/cap-conclusion}
	\input{appendices}
